...
namespace hpl {
	...
	public:
		...
		static tString GetPlatformPath(const tString &asFile);
		static tWString GetPlatformPath(const tWString &asFile);
		...
		*/
		...
		//static bool IsFileLink(const tWString &asPath);
		//static bool LinkFile(const tWString &asPointsTo, const tWString &asLink);
		//static bool RenameFile(const tWString &asFrom, const tWString &asTo);
